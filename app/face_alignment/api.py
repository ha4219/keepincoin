...
class FaceAlignment:
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
        ...
        face_detector_module = __import__('app.face_alignment.detection.' + face_detector,
...
#        fan_weights = load_url(models_urls[network_name], map_location=lambda storage, loc: storage)
        self.face_alignment_net.load_state_dict(torch.load(os.path.join(os.path.dirname(__file__), 'pretrained_models', '3DFAN4-7835d9f11d.pth.tar'), map_location='cpu'))
